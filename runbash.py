...
# for sepcial workspace dependent

_cwd='/home/14/ren/swbd'


def BashPipe(cmd):
    return pipebash(cmd, cwd=_cwd)

def BashRun(cmd, file=None):
    return bash(cwd=_cwd).run(cmd, JoinCwd(file))
